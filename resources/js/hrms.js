...
import DirectoratesList from "./components/hrms/directorates/DirectoratesList";
import DirectorateForm from "./components/hrms/directorates/DirectorateForm";
...
import DepartmentsList from "./components/hrms/departments/DepartmentsList";
import DepartmentForm from "./components/hrms/departments/DepartmentForm";
...
import SectionsList from "./components/hrms/sections/SectionsList";
import SectionForm from "./components/hrms/sections/SectionForm";
...
import BankInfo from "./components/hrms/employees/BankInfo";
...
import DivisionsList from "./components/hrms/divisions/DivisionsList";
import DivisionForm from "./components/hrms/divisions/DivisionForm";
...
Vue.component("app-directorates-list", DirectoratesList);
Vue.component("app-directorate-form", DirectorateForm);
Vue.component("app-directorate-details", DirectorateDetails);
Vue.component("app-departments", Departments);
Vue.component("app-departments-list", DepartmentsList);
Vue.component("app-department-form", DepartmentForm);
...
Vue.component("app-sections-list", SectionsList);
Vue.component("app-section-form", SectionForm);
...
Vue.component("app-divisions-list", DivisionsList);
Vue.component("app-division-form", DivisionForm);
