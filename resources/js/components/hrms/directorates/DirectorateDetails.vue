    ...
    <div class="directorate-details">
        ...
        <template v-else>
                    ...
                    <div class="row">
                                ...
                                <span class="col-sm-9">
                                    <template v-if="!!directorate.head">
                                                <span class="small text-muted">
                                                    ...
                                                    <span class="small"
                                                          v-if="!!directorate.head.designation">({{ directorate.head.designation.title }})</span>
                                                </span>
                                            </template>
                                </span>
                            </div>
                        ...
                        <div class="personal-info col-md-6">
                            <div class="row">
                                <div class="col-6"></div>
                                <div class="col-6">
                                    <button v-if="$store.getters.HAS_ANY_ACCESS(['directorates.update'])"
                                            @click="editDirectorate(directorate)" type="button"
                                            class="btn btn-outline-info btn-sm mr-5">
                                        <i class="fa fa-edit"></i> Edit
                                    </button>
                                    <button v-if="$store.getters.HAS_ANY_ACCESS(['directorates.delete'])"
                                            @click="deleteDirectorate(directorate.id)" type="button"
                ...
                <div class="row user-tabs">
                    <div class="col-lg-12 col-md-12 col-sm-12 line-tabs">
                        <ul class="nav nav-tabs nav-tabs-bottom">
                            <li class="nav-item"
                                v-if="$store.getters.HAS_ANY_ACCESS(['departments','departments.view','departments.show','departments.create','departments.update','departments.delete'])">
                                <a href="#directorate-departments" @click="getDepartments()" data-toggle="tab"
                                   class="nav-link active">Departments</a>
                            </li>
                            <li class="nav-item"
                                v-if="$store.getters.HAS_ANY_ACCESS(['divisions','divisions.view','divisions.show','divisions.create','divisions.update','divisions.delete'])">
                                <a href="#directorate-divisions" @click="getDivisions()" data-toggle="tab"
                                   class="nav-link">Divisions</a>
                            </li>
                            <li class="nav-item"
                                v-if="$store.getters.HAS_ANY_ACCESS(['sections','sections.view','sections.show','sections.create','sections.update','sections.delete'])">
                                <a href="#directorate-sections" @click="getSections()" data-toggle="tab"
                                   class="nav-link">Sections</a>
                            </li>
                            <li class="nav-item"
                                v-if="$store.getters.HAS_ANY_ACCESS(['employees','employees.view','employees.show','employees.create','employees.update','employees.delete'])">
            ...
            <div class="tab-content">
                ...
                <div
                    v-if="$store.getters.HAS_ANY_ACCESS(['departments','departments.view','departments.show','departments.create','departments.update','departments.delete'])"
                    id="directorate-departments" class="pro-overview tab-pane fade active show">
                    <div class="card mb-5">
                ...
                <div
                    v-if="$store.getters.HAS_ANY_ACCESS(['divisions','divisions.view','divisions.show','divisions.create','divisions.update','divisions.delete'])"
                    id="directorate-divisions" class="pro-overview tab-pane fade">
                    <div class="card mb-5">
                        <div class="card-body table-responsive">
                ...
                <div
                    v-if="$store.getters.HAS_ANY_ACCESS(['sections','sections.view','sections.show','sections.create','sections.update','sections.delete'])"
                    id="directorate-sections" class="pro-overview tab-pane fade">
                    <div class="card mb-5">
                        <div class="card-body table-responsive">
                ...
                <div
                    v-if="$store.getters.HAS_ANY_ACCESS(['employees','employees.view','employees.show','employees.create','employees.update','employees.delete'])"
                    id="directorate-employees" class="pro-overview tab-pane fade">
                    <div class="card mb-5">
                        <div class="card-body table-responsive">
...
export default {
    ...
    created() {
        ...
        EventBus.$on(['DEPARTMENT_SAVED', 'DEPARTMENT_DELETED'], () => {
            if (this.$store.getters.HAS_ANY_ACCESS(['departments', 'departments.view', 'departments.show', 'departments.create', 'departments.update', 'departments.delete'])) {
                this.getDepartments();
            }
        });
        EventBus.$on(['DIVISION_SAVED', 'DIVISION_DELETED'], () => {
            if(this.$store.getters.HAS_ANY_ACCESS(['divisions','divisions.view','divisions.show','divisions.create','divisions.update','divisions.delete'])) {
                this.getDivisions();
            }
        });
        EventBus.$on(['SECTION_SAVED', 'SECTION_DELETED'],() => {
            if(this.$store.getters.HAS_ANY_ACCESS(['sections','sections.view','sections.show','sections.create','sections.update','sections.delete'])){
                this.getSections();
            }
        });
        EventBus.$on([
