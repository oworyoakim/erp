<template>
    <div>
                ...
                <div class="col-lg-12 col-md-12 col-sm-12 line-tabs">
                    <ul class="nav nav-tabs nav-tabs-bottom">
                        <li class="nav-item"
                            ...
                            <a href="#executive-director-departments" @click="getDepartments()" data-toggle="tab"
                        ...
                        <li class="nav-item"
                            ...
                            <a href="#executive-director-divisions" @click="getDivisions()" data-toggle="tab"
                        ...
                        <li class="nav-item"
                            ...
                            <a href="#executive-director-sections" @click="getSections()" data-toggle="tab"
                        ...
                        <li class="nav-item"
                            ...
                            <a href="#executive-director-employees" @click="getEmployees()" data-toggle="tab"
        ...
        <div class="tab-content">
            ...
            <div
                v-if="$store.getters.HAS_ANY_ACCESS(['departments','departments.view','departments.show','departments.create','departments.update','departments.delete'])"
                id="executive-director-departments" class="pro-overview tab-pane fade active show">
                <div class="card mb-5">
            ...
            <div
                v-if="$store.getters.HAS_ANY_ACCESS(['divisions','divisions.view','divisions.show','divisions.create','divisions.update','divisions.delete'])"
                id="executive-director-divisions" class="pro-overview tab-pane fade">
                <div class="card mb-5">
                    <div class="card-body table-responsive">
            ...
            <div
                v-if="$store.getters.HAS_ANY_ACCESS(['sections','sections.view','sections.show','sections.create','sections.update','sections.delete'])"
                id="executive-director-sections" class="pro-overview tab-pane fade">
                <div class="card mb-5">
                    <div class="card-body table-responsive">
            ...
            <div
                v-if="$store.getters.HAS_ANY_ACCESS(['employees','employees.view','employees.show','employees.create','employees.update','employees.delete'])"
                id="executive-director-employees" class="pro-overview tab-pane fade">
                <div class="card mb-5">
                    <div class="card-body table-responsive">
