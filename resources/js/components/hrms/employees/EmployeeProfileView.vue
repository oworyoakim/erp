<template>
    <div>
        <!-- Page Header -->
        <div class="page-header mt-sm-1">
            <div class="row align-items-center">
                <div class="col">
                    <app-breadcrumb dashboard-link="#" :list-items="breadcrumbItems"></app-breadcrumb>
                </div>
        ...
        <template v-else>
                ...
                <div class="row user-tabs">
                    <div class="col-lg-12 col-md-12 col-sm-12 line-tabs">
                        <ul class="nav nav-tabs nav-tabs-bottom">
                            <li class="nav-item">
                                <a href="#employee-home" data-toggle="tab" class="nav-link active">
                                    Home
                                </a>
                            </li>
                            <li class="nav-item">
                                <a href="#employee-info" data-toggle="tab" class="nav-link">
                                    Personal
                                    Info
                                </a>
                            </li>
            ...
            <div class="tab-content">
                <!-- Employee Home Tab -->
                <div id="employee-home" class="pro-overview tab-pane fade active show">
                    <div class="row">
                        <div class="col-md-12">
                            <div class="row">
                ...
                <!-- Employee Info Tab -->
                <div id="employee-info" class="pro-overview tab-pane fade">
                    <div class="row">
                        <div class="col-md-12">
