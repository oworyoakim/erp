                ...
                <form @submit.prevent="saveEmployee()">
                        ...
                        <div class="row text-lg">
                            <div class="col-sm-6">
                                <div class="form-group row">
                                    <label class="col-form-label col-sm-4">Title<span
                            ...
                            <div class="col-sm-6">
                                <div class="form-group row">
                                    <label class="col-form-label col-sm-4">NSSF <span
                                        class="text-danger">*</span></label>
                                    <div class="col-sm-8">
                                        <input v-model="employee.nssf"
                                               @keyup="employee.nssf = employee.nssf.toUpperCase()"
                    ...
                    <fieldset v-if="step === 3">
                        ...
                        <div class="row text-lg">
                            <div class="col-sm-6">
                                <div class="form-group row">
                                    <label class="col-form-label col-sm-4">Role <span
                                        class="text-danger">*</span></label>
                                    <div class="col-sm-8">
