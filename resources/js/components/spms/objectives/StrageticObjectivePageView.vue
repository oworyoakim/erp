    ...
    <div class="mt-2">
            ...
            <div class="row">
                <div class="col-sm-12">
                    ...
                    <ul class="nav nav-tabs nav-tabs-bottom">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" data-toggle="tab" href="#tab_milestones">Milestones</a>
                        </li>
                    </ul>
                </div>
            </div>
        ...
        <div class="tab-content">
            ...
            <div class="tab-pane show active" id="tab_interventions">
                ...
                <div class="text-right mb-4 clearfix">
                    <button @click="editIntervention()" class="btn btn-primary add-btn" type="button"><i
                        class="fa fa-plus"></i> Add Interventions
                    </button>
                </div>
                <!-- /Add Addition Button -->
                <!-- interventions -->
                <app-interventions :interventions="interventions"/>
                <app-intervention-form :objective-id="objective.id"/>
                <!-- /interventions -->

            </div>
            <div class="tab-pane show" id="tab_outputs">

                <!-- Add Addition Button -->
                <div class="text-right mb-4 clearfix">
                    <button class="btn btn-primary add-btn" type="button" data-toggle="modal"
                            data-target="#add_addition"><i class="fa fa-plus"></i> Add Output
                    </button>
                </div>
                <!-- /Add Addition Button -->
                ...
                <div class="payroll-table card">
                    <div class="table-responsive">
                        <table class="table table-hover table-radius">
                                    ...
                                    <div class="dropdown dropdown-action">
                                        ...
                                        <div class="dropdown-menu dropdown-menu-right">
                                            <a class="dropdown-item" href="#" data-toggle="modal"
                                               data-target="#edit_addition"><i class="fa fa-pencil m-r-5"></i> Edit</a>
                                            <a class="dropdown-item" href="#" data-toggle="modal"
                                               data-target="#delete_addition"><i class="fa fa-trash-o m-r-5"></i> Delete</a>
                                        </div>
                                    </div>
                                </td>
                            </tr>
                            ...
                            <tr>
                                <th>Engage Bank of Uganda</th>
                                <td>Buy some treasury Bills and Bonds</td>
                                <td>Jackie Ochola</td>
                                <td class="text-right">
                                    <div class="dropdown dropdown-action">
                                        <a href="#" class="action-icon dropdown-toggle" data-toggle="dropdown"
            ...
            <div class="tab-pane" id="tab_indicators">
                ...
                <div class="text-right mb-4 clearfix">
                    <button class="btn btn-primary add-btn" type="button" data-toggle="modal"
                            data-target="#add_overtime"><i class="fa fa-plus"></i> Add Indicator
                    </button>
                </div>
                <!-- /Add Overtime Button -->
                                ...
                                <td class="text-right">
                                    <div class="dropdown dropdown-action">
                                        ...
                                        <div class="dropdown-menu dropdown-menu-right">
                                            ...
                                            <a class="dropdown-item" href="#" data-toggle="modal"
                                               data-target="#delete_overtime"><i class="fa fa-trash-o m-r-5"></i> Delete</a>
                                        </div>
                                    </div>
                                </td>
                            </tr>
                            <tr>
                                <th>Approval by URA</th>
            ...
            <div class="tab-pane" id="tab_milestones">
                ...
                <div class="text-right mb-4 clearfix">
                    <button class="btn btn-primary add-btn" type="button" data-toggle="modal"
                            data-target="#add_deduction"><i class="fa fa-plus"></i> Add Milestone
                    </button>
                </div>
                <!-- /Add Deductions Button -->
                ...
                <div class="payroll-table card">
                    <div class="table-responsive">
                        <table class="table table-hover table-radius">
                            ...
                            <tr>
                                ...
                                <td class="text-right">
                                    <div class="dropdown dropdown-action">
                                        ...
                                        <div class="dropdown-menu dropdown-menu-right">
                                            <a class="dropdown-item" href="#" data-toggle="modal"
                                               data-target="#edit_deduction"><i class="fa fa-pencil m-r-5"></i> Edit</a>
                                            <a class="dropdown-item" href="#" data-toggle="modal"
                                               data-target="#delete_deduction"><i class="fa fa-trash-o m-r-5"></i>
                                                Delete</a>
                                        </div>
                                    </div>
                                </td>
                            ...
                            <tr>
                                <th>Talk to Commissioner of URA</th>
                                <td>Talk to URA</td>
                                <td>Amos Welike</td>
                                <td class="text-right">
                                    <div class="dropdown dropdown-action">
...
<script>
    ...
    export default {
        ...
        created(){
            EventBus.$on(['INTERVENTION_SAVED'],this.getObjectiveDetails);
        },
        computed: {
            interventions() {
