...
<div class="header-left">
    <a href="{{route('hrms.dashboard')}}" class="logo">
            ...
            <div class="dropdown-menu dropdown-menu-right">
                @foreach($modules as $module)
                    @if($module->slug != session()->get('service'))
                        <a href="javascript:void(0);" @click="$store.dispatch('CHANGE_SERVICE','{{$module->slug}}')"
                           class="dropdown-item">
        ...
        <li class="nav-item dropdown has-arrow main-drop">
            ...
            <ul class="dropdown-menu">
                @if($user->user_type == 'employee')
                    <li class="dropdown-item"><a href="{{route('hrms.employee-profile-view')}}">My Profile</a></li>
                @endif
                @foreach($modules as $module)
                    @if($module->slug != session()->get('service'))
